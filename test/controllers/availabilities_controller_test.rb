...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post availabilities_url, params: { availability: { attendant_number: @availability.attendant_number, date: @availability.date, service_id: @availability.service_id, service_point_id: @availability.service_point_id } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { attendant_number: @availability.attendant_number, date: @availability.date, service_id: @availability.service_id, service_point_id: @availability.service_point_id } }
